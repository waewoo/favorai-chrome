...
3. **Rate.** Give each finding a severity and an effort per the `[assets/audit-template.md](../assets/audit-template.md)` legend, with a concrete `file:line`. The category is always `ui`.
